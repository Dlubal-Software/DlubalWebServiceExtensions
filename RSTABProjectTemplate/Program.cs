            ...
            try
            {
                ...
                catch (Exception exception)
                {
                    if (application != null)
                    {
                        ...
                        {
                            application.Close();
                            Console.WriteLine("Something happen:" + exception.Message);
                        }
                        else
                        {
                            application.Abort();
                            Console.WriteLine("Communication with RFEM faulted:" + exception.Message);
                        }
                ...
                finally
                {
                    ...
                    {
                        Console.WriteLine("Something wrong in finish modification of geometry\n" + exception.Message + "\n");
                        model.reset();
                        throw;
                    }
                }
